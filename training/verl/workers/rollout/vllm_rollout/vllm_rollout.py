...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        print(189,'prompts.batch["input_ids"].shape',prompts.batch["input_ids"].shape)
        print(190,'self.sampling_params',self.sampling_params)
        ...
        print(226,'generation args',kwargs)
        ...
        with self.update_sampling_params(**kwargs):
            ...
            print(246,'response.shape',response.shape)
